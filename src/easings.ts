...
// Includes slight spelling and typing changes.

export type EasingFunction = (progress: number) => number;
// prettier-ignore
export type EasingFunctionName = 'linear' | 'inQuad' | 'outQuad' | 'inOutQuad' | 'inCubic' | 'outCubic' | 'inOutCubic' | 'inQuart' | 'outQuart' | 'inOutQuart' | 'inQuint' | 'outQuint' | 'inOutQuint' | 'inSine' | 'outSine' | 'inOutSine' | 'inExpo' | 'outExpo' | 'inOutExpo' | 'inCirc' | 'outCirc' | 'inOutCirc' | 'inBack' | 'outBack' | 'inOutBack' | 'inElastic' | 'outElastic' | 'inOutElastic' | 'inBounce' | 'outBounce' | 'inOutBounce';

type EasingDictionary = {
  [easing in EasingFunctionName]: EasingFunction;
};
